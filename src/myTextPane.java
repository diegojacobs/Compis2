...
Diego Jacobs
Feb 17, 2016
Tomado de: https://code.google.com/archive/p/guz08041/source
 */
...
class myTextPanel extends JPanel{
    ...
    public myTextPanel(){
        ...
        this.textPane.setFont(myIDE.font);

        NumberInLines lineNumber = new NumberInLines(textPane);
    ...
    *****************************************/
    private void changePosSelected(){
        ...
        while(!done){
            ...
            //*************************************************
            String to_print_character = myIDE.expect(regex_character, text);
            String to_print_number = myIDE.expect(number, text);
            String to_print_id = myIDE.expect(id, text);
            String to_print_reserved_1 = myIDE.expect(regex_reserved_1, text);
            String to_print_reserved_2 = myIDE.expect(regex_reserved_2, text);
            String to_print_method = myIDE.expect(regex_method, text);
            //*************************************************
